...
public class OtherMainMenu extends JFrame {
	...
	public OtherMainMenu() {
		...
		btnNewButton.addMouseListener(new MouseAdapter(){
			...
			public void mouseClicked(MouseEvent e) {
				...
				//System.out.println(sanFranLoc.LocIsBusy());
				//System.out.println(OaklandLoc.LocIsBusy());
		...
		lblNewLabel_2.setBounds(199, 11, 149, 14);
	...
	lblNewLabel_1.setBounds(397, 26, 94, 19);
